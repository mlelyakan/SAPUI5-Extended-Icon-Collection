var ColorLibrary = {
   getColors: function (callback) {
      var colors = [
         ...
         {
            "color": "blue with a hint of purple",
            "hex": "#533cc6"
         },
         {
            "color": "booger",
